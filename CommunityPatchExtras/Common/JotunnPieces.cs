...
namespace CommunityPatchExtras.Common {
    public static class JotunnPiece {
        ...
        public static void RegisterJotunnPiece(JotunnBuildPiece jbuildpiece) {
            ...
            LGos.Prefab = CommunityPatchExtras.EmbeddedResourceBundle.LoadAsset<GameObject>($"{jbuildpiece.Prefab}.prefab");
            LGos.Sprite = CommunityPatchExtras.EmbeddedResourceBundle.LoadAsset<Sprite>($"{jbuildpiece.Sprite}.png");
