...
#pragma warning restore IDE0130
    ...
    internal static class ConfigNetwork {
        ...
        internal static void Init() {
            ...
            try {
                harmony = new Harmony(CommunityPatchExtras.PluginGUID + ".config");
        ...
        internal static void RegisterFile(YamlConfigFile file) {
            ...
            if (string.IsNullOrEmpty(file.RpcName)) {
                file.RpcName = CommunityPatchExtras.PluginName + "_" + Path.GetFileNameWithoutExtension(file.FileName);
            }
